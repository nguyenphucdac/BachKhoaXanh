...
public class Map {
	...
	public static int[][] map = { 
			...
			{ 0, 4, 5, 1, 4, 2, 4, 2, 4, 5, 0, 0, 5, 4, 2, 4, 3, 4, 2, 4, 5, 0 },
			{ 0, 4, 5, 5, 4, 2, 4, 2, 4, 5, 0, 0, 5, 4, 2, 4, 5, 4, 2, 4, 5, 0 },
			{ 0, 4, 5, 1, 4, 2, 4, 2, 4, 5, 0, 0, 5, 4, 2, 4, 5, 4, 2, 4, 5, 0 },
			{ 0, 4, 5, 5, 4, 2, 4, 2, 4, 5, 0, 0, 5, 4, 2, 4, 1, 4, 2, 4, 5, 0 },
			{ 0, 4, 4, 4, 4, 4, 4, 4, 4, 5, 4, 4, 5, 4, 4, 4, 4, 4, 4, 4, 5, 0 },
			{ 0, 4, 2, 2, 2, 2, 2, 2, 4, 5, 4, 4, 5, 4, 2, 2, 2, 2, 2, 2, 2, 0 },
			{ 0, 4, 2, 2, 2, 2, 2, 2, 4, 5, 4, 4, 5, 4, 2, 2, 2, 2, 2, 2, 2, 0 },
			{ 0, 4, 5, 2, 5, 5, 2, 5, 4, 5, 1, 1, 5, 4, 4, 4, 4, 4, 4, 3, 3, 0 },
			{ 0, 4, 5, 2, 5, 5, 2, 5, 4, 5, 1, 1, 5, 4, 5, 5, 5, 5, 5, 3, 3, 0 },
			{ 0, 4, 5, 2, 5, 5, 5, 5, 4, 5, 4, 4, 5, 4, 2, 2, 2, 2, 2, 2, 2, 0 },
			...
			{ 0, 4, 1, 5, 1, 5, 1, 5, 4, 5, 0, 0, 5, 4, 5, 1, 1, 4, 2, 4, 5, 0 },
			{ 0, 4, 4, 4, 4, 4, 4, 4, 4, 5, 0, 0, 5, 4, 5, 1, 1, 4, 2, 4, 5, 0 },
