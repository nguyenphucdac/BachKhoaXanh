...
public class TimDuongDi {
	...
	public static List<Point> timDuongDi(Point startPoint, Point targetPoint) {
		...
		while (true) {
			...
			if (freePoint[currPoint.x + 1][currPoint.y] == true && isInMap(currPoint.x + 1, currPoint.y) == true
			...
			if (freePoint[currPoint.x][currPoint.y + 1] == true && isInMap(currPoint.x, currPoint.y + 1) == true
