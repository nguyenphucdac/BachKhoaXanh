					...
					<div class="widget-shadow " data-example-id="basic-forms">
						...
						<div class="form-body">
							<form:form modelAttribute="cayForm" method="POST"
								...
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Tọa
										độ x</label>
									<div class="col-sm-9">
										<form:input path="toaDoX" type="text" class="form-control"
											id="inputPassword3" placeholder="tọa độ x"
											value="${cay.toaDoX}" />
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Tọa
										độ y</label>
									<div class="col-sm-9">
										<form:input path="toaDoY" type="text" class="form-control"
											id="inputPassword3" placeholder="tọa độ y"
											value="${cay.toaDoY}" />
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Lượng
										nước tối đa</label>
									<div class="col-sm-9">
										<form:input path="luongNuocToiDa" type="text"
											class="form-control" id="inputPassword3"
											placeholder="lượng nước cần" value="${cay.luongNuocToiDa}" />
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Lượng
										nước đã tưới</label>
									<div class="col-sm-9">
										<form:input path="luongNuocDaTuoi" type="text"
											class="form-control" id="inputPassword3"
