				...
				<div class=" form-grids row form-grids-right">
					<div class="widget-shadow " data-example-id="basic-forms">
						<div class="form-title">
							<h4>Tạo mới báo cáo điểm cấp nước :</h4>
						</div>
						<div class="form-body">
							<form:form modelAttribute="baoCaoTinhTrangDCNForm" method="POST" class="form-horizontal">
								...
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Id điểm cấp nước</label>
									<div class="col-sm-9">
										<form:input path="idDiemCapNuoc" type="text" class="form-control" id="inputPassword3" placeholder="id điểm cấp nước" />
									</div>
								</div>
								<div class="form-group">
