				...
				<div class=" form-grids row form-grids-right">
					<div class="widget-shadow " data-example-id="basic-forms">
						<div class="form-title">
							<h4>Chỉnh sửa báo cáo tình trạng điểm cấp nước :</h4>
						</div>
						<div class="form-body">
							<form:form modelAttribute="baoCaoTinhTrangDCNForm" method="POST" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<form:input path="idThanhVien" type="text" class="form-control" id="inputEmail1" value="${baoCaoTinhTrangDCN.idThanhVien }" />
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Id điểm cấp nước</label>
									<div class="col-sm-9">
										<form:input path="idDiemCapNuoc" type="text" class="form-control" id="inputPassword3" value="${baoCaoTinhTrangDCN.idDiemCapNuoc }" />
									</div>
								</div>
								<div class="form-group">
