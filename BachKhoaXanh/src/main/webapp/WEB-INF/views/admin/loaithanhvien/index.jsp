				...
				<div class=" form-grids row form-grids-right">
					<div class="widget-shadow " data-example-id="basic-forms">
						<div class="form-title col-md-12">
							<h4 class="col-md-10">Loại Thành Viên :</h4>
							<a class="agile-icon" href="${pageContext.request.contextPath}/loaithanhvien-tao-moi"><i class="fa fa-plus-square"></i> Create new</a>
							...
							<table class="table">
								...
								<tr class="active">
										...
										<td><img src="${pageContext.request.contextPath}/get-anh-loai-thanh-vien?idLoaiThanhVien=${loaiThanhVien.idLoaiThanhVien }" width="32"/></td>
