						...
						<div class="form-body">
							<form:form modelAttribute="diemCapNuocForm" method="POST" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<form:input path="idDiemCapNuoc" type="text" class="form-control" id="inputEmail3" placeholder="id" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<form:input path="luongNuocToiDa" type="text" class="form-control" id="inputPassword3" placeholder="lượng nước tối đa" />
									</div>
								</div>
								<div class="form-group">
