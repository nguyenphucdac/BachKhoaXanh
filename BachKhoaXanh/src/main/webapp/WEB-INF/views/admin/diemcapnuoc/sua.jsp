						...
						<div class="form-body">
							<form:form modelAttribute="diemCapNuocForm" method="POST" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<form:input path="toaDoX" type="text" class="form-control" id="inputPassword3" placeholder="tọa độ x" value="${diemCapNuoc.toaDoX}" />
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Tọa độ y</label>
									<div class="col-sm-9">
										<form:input path="toaDoY" type="text" class="form-control" id="inputPassword3" placeholder="tọa độ y" value="${diemCapNuoc.toaDoY}" />
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">Lượng nước tối đa</label>
									<div class="col-sm-9">
										<form:input path="luongNuocToiDa" type="text" class="form-control" id="inputPassword3" placeholder="lượng nước tối đa" value="${diemCapNuoc.luongNuocToiDa}" />
									</div>
								</div>
								<div class="form-group">
