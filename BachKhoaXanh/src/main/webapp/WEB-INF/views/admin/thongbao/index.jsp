				...
				<div class=" form-grids row form-grids-right">
					<div class="widget-shadow " data-example-id="basic-forms">
						<div class="form-title col-md-12">
							<h4 class="col-md-10">Thông Báo :</h4>
							<a class="agile-icon" href="${pageContext.request.contextPath}/thongbao-tao-moi"><i class="fa fa-plus-square"></i> Create new</a>
							...
							<table class="table">
								...
								<tbody>
								<c:forEach items="${danhSachThongBao.list}" var="thongBao">
								<tr class="active">
